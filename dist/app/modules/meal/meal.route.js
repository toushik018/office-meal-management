...
router.get("/meals/scheduled", (0, auth_1.default)("ADMIN"), meal_controller_1.MealControllers.getScheduledMealsController);
router.get("/meals/meal-choices", (0, auth_1.default)("ADMIN"), meal_controller_1.MealControllers.getMealChoicesForUsersController);
...
router.post("/meal/schedule", (0, auth_1.default)("ADMIN"), meal_controller_1.MealControllers.scheduleMealController);
